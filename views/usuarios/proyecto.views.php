...
<div class="card">
    <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#ModalProyectos">Nuevo Proyecto</button>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tituloModal">Insertar Proyecto</h5>
            ...
            <form id="form_empleados" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="Fecha">Fecha_Inicio</label>
                        <input type="date" id="Fecha" name="Fecha" class="form-control" placeholder="Ingrese la fecha" required>
                    </div>
                    <div class="form-group">
                        <label for="Nombres">Duracion</label>
                        <input type="text" name="duracion" id="duracion" class="form-control" placeholder="Ingrese su cargo" required>
                    </div>
                    <div class="form-group">
                        <label for="Nombres">Cliente</label>
                        <input type="text" name="cliente" id="cliente" class="form-control" placeholder="Ingrese su salario" required>
                    </div>
